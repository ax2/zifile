...
当前处于 **Stage 3 — Release candidate 准备**：ZIP、7z、TAR 组合和主要单流格式已经打通真实创建、浏览、完整性校验与安全解压；RAR 1.3–7 和 Windows CAB 提供只读 Beta 支持。桌面 UI 和 CLI 共用同一套 Rust 核心，x64/ARM64 构建、包审计、可复现性检查和发布演练已经自动化；可信签名、真实前台验证、实体 ARM64、WACK、Partner Center、Store 与 WinGet 仍是 1.0 外部门禁。
