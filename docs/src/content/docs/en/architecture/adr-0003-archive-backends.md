...
- CAB creation is not exposed. Read-only CAB uses MIT-licensed `cab` 0.6.0; None, MSZIP, and LZX decoding are beta capabilities, while Quantum compression and multi-cabinet sets are explicitly unsupported.
