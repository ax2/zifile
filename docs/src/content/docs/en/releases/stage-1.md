...
Double-build run `32813453959` remained 4/5 identical on both x64 and ARM64, only the default Iced EXE differing. Schema-v2 PE diagnostics now retain section hashes and bounded first-difference context for every differing component. This is an Alpha checkpoint, not a Store-ready release.
