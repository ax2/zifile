...
MSIX logos are generated automatically and covered by package audit. The Store requires at least one PC screenshot and Microsoft recommends at least four. Before submission, capture localized “home/open archive,” “create archive,” “extraction options,” and “background progress or completion” views from a signed candidate, recording viewport, scale, theme, and version. Completed listing copy does not mean the Store submission is complete.
