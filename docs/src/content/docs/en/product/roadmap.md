...
| Stage 1 | Alpha | ZIP/7z/TAR families plus beta read-only RAR 1.3–7 and Windows CAB, safe extraction, bilingual UI, search and paging, progress, cancellation, all-format parser fuzzing, and 7-Zip/RAR/CAB reference corpora are implemented; the real foreground queue round remains a release gate |
